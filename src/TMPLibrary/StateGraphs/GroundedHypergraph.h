...
class GroundedHypergraph : public StateGraph {
  ...
  public:
    ...
    bool ConnectTransition(const VID& _tail, const VID& _head, const PathConstraints& _pathConstraints={}, 
                           bool _bidirectional=false, std::set<Robot*> _avoid={});

    bool ConnectAllTransitions(const std::vector<VID>& _vertices, const PathConstraints& _pathConstraint={},
    ...
    const std::unordered_map<size_t,GH::Hyperarc>& GetHyperarcMap();
