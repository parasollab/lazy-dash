#ifndef PPL_LID_GRASP_STRATEGY_H_
#define PPL_LID_GRASP_STRATEGY_H_

#include "GraspStrategy.h"
#include "MPProblem/MPTask.h"

class LidGraspStrategy : public GraspStrategy {
  ...
  public: 
    ...
    LidGraspStrategy(XMLNode& _node);
  ...
  protected:
    ...
    Cfg SampleObjectPose(Robot* _refRobot, Robot* _object, Interaction* _interaction);
