#ifndef PPL_BAKE_STRATEGY_H_
#define PPL_BAKE_STRATEGY_H_

#include "GraspStrategy.h"

#include "MPProblem/MPTask.h"

class BakeStrategy : public GraspStrategy {
  ...
  protected:
    ...
    // Cfg SampleObjectPose(Robot* _object, Robot* _refRobot, Interaction* _interaction);
    // Cfg SampleObjectPoseSimple(Robot* _object, Robot* _refRobot, Interaction* _interaction);
    ...
    // Cfg ComputeManipulatorCfg(Robot* _robot, std::map<Robot*,Cfg>& objectPoses, Transformation& _transform);
