...
class SMART : public TaskEvaluatorMethod {
  ...
  public: 
    ...
    typedef std::map<GroupRoadmapType*,
              std::priority_queue<pair<double,VID>,
                std::vector<std::pair<double,VID>>,
                std::greater<std::pair<double,VID>>>>     NeighborCandidates;
  ...
  protected:
    ...
    size_t ExtendToNeighbor(NeighborCandidates& _neighborCandidates, NeighborCandidates::iterator _iter, std::vector<Vertex> _partials, const VID& _qNear);
