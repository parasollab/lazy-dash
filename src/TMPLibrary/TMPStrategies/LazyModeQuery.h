#ifndef PPL_LAZY_MODE_QUERY_H_
#define PPL_LAZY_MODE_QUERY_H_
...
class LazyModeQuery : public TMPStrategyMethod {
  ...
  public:
    ...
    LazyModeQuery(XMLNode& _node);

    virtual ~LazyModeQuery();
  ...
  private:
    ...
    bool FindTaskPlan(Decomposition* _decomp);
    double FindMotionPlan(Decomposition* _decomp,bool _useExtraEval=false);
    ...
    std::string m_initialMotionEvaluator;
