...
MPTask(MPProblem* const _problem, XMLNode& _node) {
  ...
  std::cout << "Constructing task for robot: " << m_robot->GetLabel() << std::endl;
  ...
  for(auto& child : _node) {
    if(child.Name() == "StartConstraints") {
      ...
      std::cout << "getting goal constraints" << std::endl;
      for(auto& grandChild : child)
...
operator=(const MPTask& _other) {
  if(this != &_other) {
    ...
    // std::cout << "Printing constraints labels = " << m_pathConstraints.size() << " " << _other.m_pathConstraints.size() << std::endl;
    // for(auto& c : m_pathConstraints) {
    //   std::cout << c->GetLabel() << std::endl;
    // }
    // std::cout << "Done1" << std::endl;
    // for(auto& c : _other.m_pathConstraints) {
    //   std::cout << c->GetLabel() << std::endl;
    // }
    ...
    // std::cout << "After the Clone" << std::endl;
    // for(auto& c : m_pathConstraints) {
    //   std::cout << c->GetLabel() << std::endl;
    // }
    // std::cout << "Done2" << std::endl;
  ...
  // std::cout << "Return" << std::endl;
  // for(auto& c : this->m_pathConstraints) {
  //   std::cout << c->GetLabel() << std::endl;
  // }
