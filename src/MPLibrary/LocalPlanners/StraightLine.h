...
IsConnected(const GroupCfgType& _c1, const GroupCfgType& _c2, GroupCfgType& _col,
  ...
  // std::cout << "increment: " << increment.PrettyPrint() << std::endl;
  ...
  for(int i = 1; i < numSteps; ++i) {
    ...
    // std::cout << "previous step: " << previousStep.PrettyPrint() << std::endl;
    // std::cout << " -> increment: " << increment.PrettyPrint() << std::endl;
    // std::cout << "current step: " << currentStep.PrettyPrint() << std::endl;
    ...
    if(_checkCollision) {
      ...
      if(!inBounds or !vc->IsValid(currentStep, id)) {
        // std::cout << "not in bound and invalid sample" << std::endl;
        _col = currentStep;
        connected = false;
        break;
      }
      // else{
      //   std::cout << "in bound and valid sample" << std::endl;
      // }
    }
    ...
    if(_savePath) {
      ...
      // std::cout << "Adding current step: " << currentStep.PrettyPrint() << std::endl;
    }
  }
