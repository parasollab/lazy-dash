...
*/
    ...
    std::vector<typename RoadmapType::VP> ReconstructEdge(
        typename RoadmapType::VP _source, typename RoadmapType::VP _target,
        const double _posRes, const double _oriRes);
    ...
    std::vector<typename GroupRoadmapType::VP> ReconstructEdge(
        typename GroupRoadmapType::VP _source, typename GroupRoadmapType::VP _target,
        const double _posRes, const double _oriRes);
...
ReconstructEdge(RoadmapType* const _roadmap, const VID _source,
  ...
  std::vector<typename MPTraits::RoadmapType::VP> emptyEdge;
  if(_source == _target)
    return emptyEdge;
...
std::vector<typename MPTraits::RoadmapType::VP>
MPLibraryType<MPTraits>::
ReconstructEdge(typename MPTraits::RoadmapType::VP _source,
    typename MPTraits::RoadmapType::VP _target, const double _posRes,
    const double _oriRes) {
  ...
  const auto& end           = _target;

  // Construct the set of start, intermediates, and end waypoints as needed.
  std::vector<typename MPTraits::RoadmapType::VP> waypoints = {start,end};
...
std::vector<typename MPTraits::GroupRoadmapType::VP>
MPLibraryType<MPTraits>::
ReconstructEdge(typename MPTraits::GroupRoadmapType::VP _source,
    typename MPTraits::GroupRoadmapType::VP _target, const double _posRes,
    const double _oriRes) {

  std::vector<typename MPTraits::GroupRoadmapType::VP> emptyEdge;
  if(_source == _target)
    return emptyEdge;
  ...
  // Construct the set of start, intermediates, and end waypoints as needed.
  std::vector<typename MPTraits::GroupRoadmapType::VP> waypoints = {start,end};
