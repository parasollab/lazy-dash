...
class PathModifierMethod : public MPBaseObject<MPTraits> {
  ...
  public:
    ...
    virtual void Modify(vector<GroupCfgType>& _path,
        vector<GroupCfgType>& _newPath);
    ...
    virtual void Modify(GroupRoadmapType* _graph, vector<GroupCfgType>& _path,
                        vector<GroupCfgType>& _newPath);
  ...
  protected:
    ...
    virtual bool ModifyImpl(GroupRoadmapType* _graph, vector<GroupCfgType>& _path,
        vector<GroupCfgType>& _newPath) = 0;
...
/*-------------------GroupCfg PathModifier Interface -------------------------*/

template <typename MPTraits>
void
PathModifierMethod<MPTraits>::
Modify(vector<GroupCfgType>& _path, vector<GroupCfgType>& _newPath) {
  ModifyImpl(this->GetGroupRoadmap(), _path, _newPath);
}

template <typename MPTraits>
void
PathModifierMethod<MPTraits>::
Modify(GroupRoadmapType* _groupRoadmap, vector<GroupCfgType>& _path, vector<GroupCfgType>& _newPath) {
  ModifyImpl(_groupRoadmap, _path, _newPath);
}
