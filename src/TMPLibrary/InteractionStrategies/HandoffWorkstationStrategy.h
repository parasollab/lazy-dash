#ifndef PPL_HANDOFF_WORKSTATION_STRATEGY_PPL_
#define PPL_HANDOFF_WORKSTATION_STRATEGY_PPL_

#include "GraspStrategy.h"

class HandoffWorkstationStrategy : public GraspStrategy {
  ...
  public:
    ...
    HandoffWorkstationStrategy(XMLNode& _node);
